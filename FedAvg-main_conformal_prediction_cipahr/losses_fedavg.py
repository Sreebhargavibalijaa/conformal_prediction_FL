...
from utils import arg_parser, average_weights,fedmed, Logger, average_weights_losses_30, average_weights_losses_50, average_weights_losses_70
...
class FedAvg:
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.args.n_epochs):
            ...
            updated_weights = average_weights_losses_70(clients_models, clients_losses)
