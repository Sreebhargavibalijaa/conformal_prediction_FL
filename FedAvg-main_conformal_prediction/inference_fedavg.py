...
from utils import arg_parser, average_weights,fedmed, Logger, average_weights_time_50_prune,average_weights_time_30_prune,average_weights_time_70_prune
...
class FedAvg:
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.args.n_epochs):
            ...
            updated_weights = average_weights_time_70_prune(clients_models, times)
